...
class Inode extends GridItem {
    constructor(inum) {
        ...
        this.inum = inum;
        this.inode = new DataView(
            image,
            Config.blockSize * superBlock.inodestart + inum * Config.inodeSize,
            Config.inodeSize
        );
        ...
        if (numberOfAddresses > Config.numberOfDirectAddress) {
            ...
            if (indirectAddress !== 0 && blockList[indirectAddress]) {
    ...
    checkError() {
        ...
        if (this.inum === 0 && this.type !== 0)
            return "Inode 0 should remain unused in xv6.";
